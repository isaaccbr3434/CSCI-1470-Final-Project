...
def prepare_data2():
    ...
    for ticker in omx30_tickers:
        ...
        all_target.extend(targets.values)
    ...
    print("Total number of daily stock data:", len(all_target), "days across 26 stocks")
    print("Total number of days that stock went up:", all_target.count(1))
